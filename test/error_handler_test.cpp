...
////    BOOST_TEST((to_string<utf16>(e1) == u"\xFFFD");
...
//  }
  ...
  void default_arguments()
  {
    ...
    BOOST_TEST((to_string<utf16>(U"A\x110000Z", err16())
      == u"A*ill*Z"));
  ...
  void ill_formed_utf32_source()
  {
    ...
    BOOST_TEST((to_string<wide>(u32str, errw()) == wstr));
    BOOST_TEST((to_string<utf8>(u32str, err8()) == u8str));
    BOOST_TEST((to_string<utf16>(u32str, err16()) == u16str));
    BOOST_TEST((to_string<utf32>(u32str, err32()) == u32str));
    ...
    BOOST_TEST((to_string<wide>(ill_u32str, errwnul()) == wstr));
    BOOST_TEST((to_string<utf8>(ill_u32str, err8nul()) == u8str));

    BOOST_TEST((to_string<utf16>(ill_u32str, err16nul()) == u16str));

    BOOST_TEST((to_string<utf32>(ill_u32str, err32nul()) == u32str));
  ...
  void ill_formed_utf16_source()
  {
    ...
    // ditto with user supplied error handler
    BOOST_TEST((to_string<wide>(u16str, errw()) == wstr));
    BOOST_TEST((to_string<utf8>(u16str, err8()) == u8str));
    BOOST_TEST((to_string<utf16>(u16str, err16()) == u16str));
    BOOST_TEST((to_string<utf32>(u16str, err32()) == u32str));

    BOOST_TEST((to_string<utf16>("\xed\xa0\x80") == u"\uFFFD"));
    BOOST_TEST((to_string<utf16>("\xed\xa0\x80", err16()) == u"*ill*"));
    BOOST_TEST((to_string<utf16>("\xed\xa0\x80", err16nul()) == u""));

    BOOST_TEST((to_string<wide>(ill_u16str, errwnul()) == wstr));
    BOOST_TEST((to_string<utf8>(ill_u16str, err8nul()) == u8str));
    BOOST_TEST((to_string<utf16>(ill_u16str, err16nul()) == u16str));
    BOOST_TEST((to_string<utf32>(ill_u16str, err32nul()) == u32str));
  ...
  void ill_formed_utf8_source()
  {
    ...
    // ditto with user supplied error handler
    BOOST_TEST((to_string<wide>(u8str, errw()) == wstr));
    BOOST_TEST((to_string<utf8>(u8str, err8()) == u8str));
    BOOST_TEST((to_string<utf16>(u8str, err16()) == u16str));
    BOOST_TEST((to_string<utf32>(u8str, err32()) == u32str));

    BOOST_TEST((to_string<utf32>("\xed\xa0\x80") == U"\uFFFD"));
    BOOST_TEST((to_string<utf32>("\xed\xa0\x80", err32()) == U"*ill*"));
    BOOST_TEST((to_string<utf32>("\xed\xa0\x80", err32nul()) == U""));

    BOOST_TEST((to_string<utf16>("\xed\xa0\x80") == u"\uFFFD"));
    BOOST_TEST((to_string<utf16>("\xed\xa0\x80", err16()) == u"*ill*"));
    BOOST_TEST((to_string<utf16>("\xed\xa0\x80", err16nul()) == u""));

    BOOST_TEST((to_string<wide>(ill_u8str, errwnul()) == wstr));
    BOOST_TEST((to_string<utf8>(ill_u8str, err8nul()) == u8str));
    //cout << hex_string(u8str) << endl;
    //cout << hex_string(to_string<utf8>(ill_u8str)) << endl;
    BOOST_TEST((to_string<utf16>(ill_u8str, err16nul()) == u16str));
    BOOST_TEST((to_string<utf32>(ill_u8str, err32nul()) == u32str));
  ...
  void ill_formed_wide_source()
  {
    ...
    // ditto with user supplied error handler
    BOOST_TEST((to_string<wide>(wstr, errw()) == wstr));
    BOOST_TEST((to_string<utf8>(wstr, err8()) == u8str));
    BOOST_TEST((to_string<utf16>(wstr, err16()) == u16str));
    BOOST_TEST((to_string<utf32>(wstr, err32()) == u32str));

    BOOST_TEST((to_string<wide>(ill_wstr, errwnul()) == wstr));
    BOOST_TEST((to_string<utf8>(ill_wstr, err8nul()) == u8str));
    BOOST_TEST((to_string<utf16>(ill_wstr, err16nul()) == u16str));
    BOOST_TEST((to_string<utf32>(ill_wstr, err32nul()) == u32str));
